package io.murad.askdev.security;
...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            throw new AskDevException("Exception occurred while loading keystore");
        }
    }
...
//        User principal = (User) authentication.getPrincipal();
    ...
    private PrivateKey getPrivateKey() throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException {
        try {
            ...
            throw new AskDevException("Exception occurred while retrieving public key from keystore.");
        }
    }
